        ...
        <div className='px-2 md:px-16'>
          <motion.div
            ...
            <div className='flex flex-row items-center relative'>
              <button onClick={() => { dispatch(setboolNavbar()) }} className='uppercase bg-orange py-2 w-24 sm:w-32 text-center rounded-xl text-white font-bold text-xs md:text-sm cursor-pointer'>{t('booking')}</button>
              <div>
