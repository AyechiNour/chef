...
const Gallery = () => {
    ...
    const title = {
        part1: t('gallery.part1'),
        part2: t('gallery.part2')
    }
            ...
            <div style={{ backgroundColor: "#F2F2F2" }} className='mt-5 pt-2'>
                ...
                <div className='grid grid-cols-3 grid-rows p-1 sm:p-3 md:p-4 xl:p-10'>
                    <div className='cursor-pointer row-span-2 col-span-1 m-1 md:m-2 relative'>
                        ...
                        <img className='w-full' src="/images/img1.png" alt="" srcSet="" />
                    </div>
                    <div className='cursor-pointer row-span-1 col-span-1 m-1 md:m-2 relative'>
                        ...
                        <img className='w-full' onClick={() => { setapparence(true); setimg("/images/img2.png"); document.body.style.overflow = "hidden" }} src="/images/img2.png" alt="" srcSet="" />
                    </div>
                    <div className='cursor-pointer row-span-1 col-span-1 m-1 md:m-2 relative'>
                        ...
                        <img className='w-full' onClick={() => { setapparence(true); setimg("/images/img3.png"); document.body.style.overflow = "hidden" }} src="/images/img3.png" alt="" srcSet="" />
                    </div>
                    <div className='cursor-pointer row-span-1 col-span-1 m-1 md:m-2 relative'>
                        ...
                        <img className='w-full' onClick={() => { setapparence(true); setimg("/images/img4.png"); document.body.style.overflow = "hidden" }} src="/images/img4.png" alt="" srcSet="" />
                    </div>
                    <div className='cursor-pointer row-span-2 col-span-1 m-1 md:m-2 relative'>
                        ...
                        <img className='w-full' onClick={() => { setapparence(true); setimg("/images/img5.png"); document.body.style.overflow = "hidden" }} src="/images/img5.png" alt="" srcSet="" />
                    </div>
                    <div className='cursor-pointer row-span-1 col-span-2 m-1 md:m-2 relative'>
                        ...
                        <img className='w-full' onClick={() => { setapparence(true); setimg("/images/img6.png"); document.body.style.overflow = "hidden" }} src="/images/img6.png" alt="" srcSet="" />
                    </div>
                </div>
            </div>
        </section>
